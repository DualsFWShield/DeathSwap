...
public class DeathSwapPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.blockShuffleGUI = new be.dualsfwshield.deathswap.gui.BlockShuffleGUI(this);
        getServer().getPluginManager().registerEvents(blockShuffleGUI, this);
    ...
    public be.dualsfwshield.deathswap.gui.HelpGUI getHelpGUI() {
        return helpGUI;
    }

    public be.dualsfwshield.deathswap.gui.BlockShuffleGUI getBlockShuffleGUI() {
        return blockShuffleGUI;
    }
